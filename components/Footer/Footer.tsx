...
import { getWebsiteInfoAction, getWebsiteData } from '../../_redux/store/action/globalAction';

const Footer = () => {
    const { websiteInfoLoading, websiteInfo } = useSelector((state: IRootReducer) => state.global)
                        ...
                        <div className="col-md-3 col-xs-6">
                            <div className="footer-info">
                                ...
                                <div className="mb-2">
                                    <div>Phone</div>
                                    <div style={{ fontSize: '14px' }}>
                                        <a href={`tel:${getWebsiteData('phone_no')}`} className="text-white">{getWebsiteData('phone_no')}</a>
                                    </div>
                                </div>
                                ...
                                <div className="mb-2">
                                    <div>Email</div>
                                    <div style={{ fontSize: '14px' }}>
                                        <a href={`mailto:${getWebsiteData('email')}`} className="text-white">{getWebsiteData('email')}</a>
                                    </div>
                                </div>
                                {getWebsiteData('app_playstore_link').length > 0 &&
                                    <div>
                                        <Link href={getWebsiteData('app_playstore_link')} passHref={true}>
                                            <a target="_blank">
                            ...
                            <div className="footer-info">
                                ...
                                {getWebsiteData('registered_name').length > 0 &&
                                    <div className="mb-2">
                                        ...
                                        <div style={{ fontSize: '14px' }}>{getWebsiteData('registered_name')}</div>
                                    </div>
                                }
                                ...
                                {getWebsiteData('trade_license_no').length > 0 &&
                                    <div className="mb-2">
                                        ...
                                        <div style={{ fontSize: '14px' }}>{getWebsiteData('trade_license_no')}</div>
                                    </div>
                                }
                                ...
                                {getWebsiteData('vat_reg_no').length > 0 &&
                                    <div className="mb-2">
                                        ...
                                        <div style={{ fontSize: '14px' }}>{getWebsiteData('vat_reg_no')}</div>
                                    </div>
                                }
                                ...
                                {getWebsiteData('tin').length > 0 &&
                                    <div className="mb-2">
                                        <div>E-TIN</div>
                                        <div style={{ fontSize: '14px' }}>{getWebsiteData('tin')}</div>
                                    </div>
                                }
                                {
                                        ...
                                        <div>
                                            <div style={{ width: '80px', height: '80px' }}>
                                                <a href={getWebsiteData('app_appstore_link')}>
                                                    <img width="80" height="80" src="/images/appstore.png" alt="apple store qr code" />
                                                </a>
                                            </div>
                                        </div>
                                    )
