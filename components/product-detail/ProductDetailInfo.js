...
const ProductDetailInfo = (props) => {
  ...
  } = useCallback(priceCalculation(product), [productId]);
              ...
              <div className="">
                <div className="card shadow-md">
                  <div className="row ">
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6 px-0">
                            <div className="product_details_information py-2">
                              ...
                              >
                                <h2 className="product_title pt-3 text-uppercase mb-0">
                              ...
                              <div
                                className="font-weight-600 py-4"
                                style={{ borderBottom: "2px dashed #ddd" }}
                              >
                    ...
                    {/*Location Section*/}
                    <div
                      className="col-lg-3 col-md-12 pt-3 pt-md-0"
