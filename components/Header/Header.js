...
import { getWebsiteData, toggleBackdrop, toggleFloatingCart } from "../../_redux/store/action/globalAction";
            ...
            <div className="header__top">
              ...
              <div className="header__logo pr-md-2">
                <div className="header__logo-box">
                  <Link href="/">
                    <a>
                      <img src={getWebsiteData('logo').length === 0 ? `/images/logos/logo.png` : process.env.NEXT_PUBLIC_URL + 'images/website/' + getWebsiteData('logo')} alt="Lacefeeta" className="text-black" />
                    </a>
                  </Link>
                </div>
              </div>
